...
namespace Invector.vCharacterController
{
    public class vThirdPersonMotor : MonoBehaviour
    {
        ...
        [HideInInspector] public PhysicMaterial frictionPhysics, maxFrictionPhysics, slippyPhysics;         // create PhysicMaterial for the Rigidbody
        ...
        public virtual void MoveCharacter(Vector3 _direction)
        {
            ...
            if (!isGrounded || isJumping || _rigidbody.velocity.y > 4) return;
        ...
        protected virtual void CheckGroundDistance()
        {
            if (_capsuleCollider != null)
            {
                ...
                {
                    float hitAngle = Vector3.Angle(Vector3.up, groundHit.normal);
